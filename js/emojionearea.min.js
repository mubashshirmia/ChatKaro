...
function myInpfunction() {
    var x = document.getElementsByClassName("emojionearea-editor").value;
    
      
      if(x=="")
      {
      document.getElementById("sendi").style.display= "none";
      document.getElementById("messagei").style.display="inline-block";
      
      }
      
      else
      {
      document.getElementById("messagei").style.display="none";
      document.getElementById("sendi").style.display= "inline-block";
      }
